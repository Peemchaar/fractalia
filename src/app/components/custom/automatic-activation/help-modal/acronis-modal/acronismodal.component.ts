...
@Component({
  selector: 'app-acronismodal',
  templateUrl: './acronismodal.component.html',
  styleUrls: ['./acronismodal.component.scss']
})
export class AcronismodalComponent implements OnInit {
